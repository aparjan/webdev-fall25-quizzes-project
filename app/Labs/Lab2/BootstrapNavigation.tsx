import { Container, Nav, NavLink, NavItem } from "react-bootstrap";
import {Card, CardImg, CardTitle, Button, CardText, CardBody} from "react-bootstrap";
                 ...
                 <CardImg variant="top" src="images/stacked.jpg" />
                  <CardBody>
                     <CardTitle>Stacking Starship</CardTitle>
                      <CardText> Stacking the most powerful rocket in history. Mars or bust! </CardText>

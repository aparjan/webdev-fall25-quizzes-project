...
import { InputGroup, Col, Row, Button } from "react-bootstrap";
        ...
        <Container>
            ...
            <div id="wd-css-responsive-forms-1">
                ...
                <Row className="mb-3" controlid="email1">
                    ...
                    <Col sm={10}> <FormControl type="email" defaultValue="email@example.com" /> </Col>
                </Row>
                <Row className="mb-3" controlid="password1">
                    <FormLabel column sm={2}> Password </FormLabel>
                    <Col sm={10}> <FormControl type="password" /> </Col>
                </Row>
                <Row className="mb-3" controlid="textarea2">
                    <FormLabel column sm={2}> Bio </FormLabel>
                    <Col sm={10}> <FormControl as="textarea" style={{ height: "100px" }} /> </Col>
                </Row>
            </div>
            <br />
                ...
                <Form>
                    ...
                    <fieldset>
                        <Row className="mb-3">
                            ...
                            <Col sm={10}> <FormCheck type="radio" label="First radio" name="formHorizontalRadios" defaultChecked />
